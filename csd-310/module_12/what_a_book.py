...
def add_book_to_wishlist(cursor, user_id, _book_id):
    _cursor.execute("INSERT INTO wishlist(user_id, book_id) VALUES({}, {})".format(user_id, _book_id))

try:
# try/catch block for handling potential MySQL database errors """ 

    db = mysql.connector.connect(**configuration) # connect to the WhatABook database 
